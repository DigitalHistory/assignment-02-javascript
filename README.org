...
*Please make use of the Javascript resources which can be found [[https://digitalhistory.github.io/dh-website/js-resources-tools/][in the  Tools section of the website]].*  For this assignment, you will certainly want to read much of [[https://developer.mozilla.org/en-US/docs/Learn/JavaScript/First_steps][First steps]] and [[https://developer.mozilla.org/en-US/docs/Learn/JavaScript/Building_blocks][Building Blocks]] in MDN, and will benefit from exploring further.

...
*Please make use of the Javascript resources which can be found [[https://q.utoronto.ca/courses/233553/pages/javascript-resources-and-tools][on Quercus]].*  For this assignment, you will certainly want to read much of [[https://developer.mozilla.org/en-US/docs/Learn/JavaScript/First_steps][First steps]] and [[https://developer.mozilla.org/en-US/docs/Learn/JavaScript/Building_blocks][Building Blocks]] in MDN, and will benefit from exploring further.
